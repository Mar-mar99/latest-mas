...
import 'package:masbar/features/user/offeres/presentation/request_offer/widgets/offer_step1/select_payment_mode_offer.dart';
...
import '../../../../../favorites/presentation/request_fav/widgets/fav_step1/select_payment_mode_fav.dart';
...
class OfferStep1 extends StatelessWidget {
  ...
  OfferStep1({
    ...
    required this.changeCurrentTab, required this.provider,
  }) : super(key: key);
      ...
      child: SizedBox(
        child: Column(
          children: [
            ...
            BlocBuilder<RequestOfferBloc, RequestOfferState>(
              builder: (context, state) {
                return AppButton(
          ...
          InkWell(
            onTap: () {
              showCustomBottomSheet(
                context: context,
                child: BlocProvider.value(
                  value: BlocProvider.of<RequestOfferBloc>(context),
                  child: const SelectPaymentMethodOffer(),
                ),
              );
            },
            child: Container(
  ...
  Row _buildType(BuildContext context) {
   ...
   Row _buildDiscount(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        AppText('Discount'),
  ...
  Widget _buildSlider(BuildContext context) {
    return    BlocBuilder<RequestOfferBloc, RequestOfferState>(
          ...
          SizedBox(
              ...
              child: Slider(
                ...
                onChanged: (double value) {
                  BlocProvider.of<RequestOfferBloc>(context)

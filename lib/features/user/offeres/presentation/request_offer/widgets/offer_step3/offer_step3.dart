...
import 'package:masbar/features/user/offeres/presentation/request_offer/widgets/offer_step3/schedule_service_offer.dart';
...
class OfferStep3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<RequestOfferBloc, RequestOfferState>(
  ...
  void _buildListener(RequestOfferState state) async {
  ...
  Widget _buildSelecteDateTime(BuildContext context) {
    return BlocBuilder<RequestOfferBloc, RequestOfferState>(
      builder: (context, state) {
        return state.isSchedule ? const ScheduleServiceOffer() : Container();
      },
    );
  }
  ...
  Widget _buildAddImageItem(
    ...
    return Expanded(
      child: BlocBuilder<RequestOfferBloc, RequestOfferState>(
        builder: (context, state) {
          return InkWell(

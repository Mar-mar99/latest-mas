...
import 'package:masbar/features/user/services/presentation/request_service/masbar_choosen/widgets/step1/select_payment_method.dart';
import 'package:masbar/features/user/services/presentation/request_service/masbar_choosen/widgets/step1/select_promo_code.dart';
          ...
          onTap: () {
            showCustomBottomSheet(
              ...
              child: BlocProvider.value(
                value: BlocProvider.of<CreateRequestBloc>(context),
                child: const SelectPromoCode(),
              ),
            );
          },
          child: Container(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              AppText('${state.distance} KM',fontSize: 14,)
            ],
          ),
         SizedBox(

...
import 'package:masbar/features/user/my_locations/data/model/my_locations_model.dart';
...
class UserRequestStep2 extends StatefulWidget {
  final Function changeCurrentTab;
  const UserRequestStep2({
    Key? key,
    required this.changeCurrentTab,
  }) : super(key: key);

  @override
  State<UserRequestStep2> createState() => _UserRequestStep2State();
}

class _UserRequestStep2State extends State<UserRequestStep2> {
  ...
  void initState() {
    super.initState();
    if (context.read<UserCreateRequestBloc>().state.latitude != 0) {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child:
                              Text(AppLocalizations.of(context)!.save_and_pick),
                        ))
                      ],
                    ),
                  ],

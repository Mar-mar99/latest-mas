...
class UserSelectPromoCode extends StatefulWidget {
  const UserSelectPromoCode({super.key});

  @override
  State<UserSelectPromoCode> createState() => _UserSelectPromoCodeState();
}

class _UserSelectPromoCodeState extends State<UserSelectPromoCode> {
      ...
      child: Builder(builder: (context) {
        return BlocBuilder<GetPromosBloc, GetPromosState>(
          ...
          if (state is LoadingGetPromos) {
            ...
            return _buildNetwork(state, context);
  ...
  NetworkErrorWidget _buildNetwork(

...
import 'package:masbar/features/user/favorites/presentation/request_fav/widgets/fav_step3/schedule_service_fav.dart';
...
class FavStep3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<RequestFavProviderBloc, RequestFavProviderState>(
  ...
  void _buildListener(RequestFavProviderState state) async {
  ...
  Widget _buildSelecteDateTime(BuildContext context) {
    return BlocBuilder<RequestFavProviderBloc, RequestFavProviderState>(
      builder: (context, state) {
        return state.isSchedule ? const ScheduleServiceFav() : Container();
      },
    );
  }
  ...
  Widget _buildAddImageItem(
    ...
    return Expanded(
      child: BlocBuilder<RequestFavProviderBloc, RequestFavProviderState>(
        builder: (context, state) {
          return InkWell(

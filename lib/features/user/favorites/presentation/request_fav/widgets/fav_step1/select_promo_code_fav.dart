...
class SelectPromoCodeFav extends StatefulWidget {
  const SelectPromoCodeFav({super.key});

  @override
  State<SelectPromoCodeFav> createState() => _SelectPromoCodeFavState();
}

class _SelectPromoCodeFavState extends State<SelectPromoCodeFav> {
      ...
      onTap: () {
        if (selected == null) {
          BlocProvider.of<RequestFavProviderBloc>(context).add(
            WithPromoChangedEvent(withPromo: true),
          );
        } else {
          BlocProvider.of<RequestFavProviderBloc>(context).add(

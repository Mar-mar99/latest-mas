...
class FavStep2 extends StatefulWidget {
  ...
  @override
  State<FavStep2> createState() => _FavStep2State();
}

class _FavStep2State extends State<FavStep2> {
  ...
  void initState() {
    super.initState();
    if (context.read<RequestFavProviderBloc>().state.latitude != 0) {
      currentUserCoords = GeoLoc(
          lat: context.read<RequestFavProviderBloc>().state.latitude,
          lng: context.read<RequestFavProviderBloc>().state.longitude);

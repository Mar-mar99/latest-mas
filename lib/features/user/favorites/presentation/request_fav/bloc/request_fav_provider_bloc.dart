...
import '../../../domain/use_cases/create_fav_request_use_case.dart';

part 'request_fav_provider_event.dart';
part 'request_fav_provider_state.dart';

class RequestFavProviderBloc
    extends Bloc<RequestFavProviderEvent, RequestFavProviderState> {
  final CreateFavRequestUseCase createFavRequestUseCase;
  RequestFavProviderBloc({
    required this.createFavRequestUseCase,
  }) : super(RequestFavProviderState.empty()) {
   ...
   on<WithPromoChangedEvent>((event, emit) {
    ...
    on<SubmitRequestEvent>((event, emit) async {
      ...
      final res = await createFavRequestUseCase.call(
        lat: state.latitude,
        lng: state.longitude,
        ...
        paymentMethod: state.paymentStatus == ServicePaymentType.free
            ...
            : state.paymentMethod!,
        promoCode:
            state.promoCode == null ? null : state.promoCode!.promoCodeId,

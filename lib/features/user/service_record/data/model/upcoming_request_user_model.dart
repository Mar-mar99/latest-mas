...
class UpcomingRequestUserModel extends UpcomingRequestUserEntity {
  UpcomingRequestUserModel(
      {super.id,
      super.bookingId,
      super.userId,
      super.providerId,
  ...
  factory UpcomingRequestUserModel.fromJson(Map<String, dynamic> json) {
    return UpcomingRequestUserModel(
      id: json['id'],
